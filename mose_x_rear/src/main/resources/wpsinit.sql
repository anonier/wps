...
-- Records of w_file_t
-- ----------------------------
INSERT INTO `w_file_t` (id, name, version, size, creator, create_time, modifier, modify_time, download_url)
VALUES ('1', 'log.doc', 1, 25, '1', 1563079046, '1', 1563079046, 'https://xxx/log.doc');
...
-- ----------------------------
INSERT INTO `w_file_watermark_t`
VALUES (1, '1', 0, '', 'rgba( 192, 192, 192, 0.6 )', 'bold 20px Serif', 0, 50, 50);
...
-- ----------------------------
INSERT INTO `w_user_acl_t`
VALUES (1, 1, '1', 'write', 0, 0);
INSERT INTO `w_user_acl_t`
VALUES (2, 2, '2', 'write', 0, 0);
...
-- Records of w_user_t
-- ----------------------------
INSERT INTO `w_user_t`
VALUES ('1', '张三', 'https://xxx/user0.png');
INSERT INTO `w_user_t`
VALUES ('2', '李四', 'https://xxx/user1.png');
INSERT INTO `w_user_t`
VALUES ('3', '赵五', 'https://xxx/user2.png');
